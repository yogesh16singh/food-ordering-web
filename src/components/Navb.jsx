...
function Navb() {
    ...
    return (<div>
        <div className="navb">
            ...
            <ul>
                <li className="y_navb_li"><Link to={"/"}>Home</Link></li>
                <li className="y_navb_li"><Link to={"/about"}>About</Link></li>
                <li className="y_navb_li"><Link to={"/contact"}>Contact Us</Link></li>
            </ul>
            {isLogin
                ?
